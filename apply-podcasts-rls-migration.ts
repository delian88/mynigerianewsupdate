...
const sqlPath = path.resolve(__dirname, 'supabase/migrations/20260601140000_fix_podcasts_rls.sql');
const query = fs.readFileSync(sqlPath, 'utf8');

console.log(`Connecting to project: ${projectRef}`);
console.log('Applying podcasts RLS migration...');
...
if (!res.ok) {
  ...
  console.log(`✅ Podcasts RLS migration applied successfully!`);
}
