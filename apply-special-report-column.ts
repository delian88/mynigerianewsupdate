...
const sqlPath = path.resolve(__dirname, 'supabase/migrations/20260601150000_add_special_report_column.sql');
const query = fs.readFileSync(sqlPath, 'utf8');

console.log(`Connecting to project: ${projectRef}`);
console.log('Adding is_special_report column to articles...');
...
if (!res.ok) {
  ...
  console.log(`✅ is_special_report column added successfully!`);
}
