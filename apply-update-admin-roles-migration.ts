...
const sqlPath = path.resolve(__dirname, 'supabase/migrations/20260530140000_update_admin_roles.sql');
const query = fs.readFileSync(sqlPath, 'utf8');

console.log(`Connecting to project: ${projectRef}`);
console.log('Applying update admin roles migration...');
...
if (!res.ok) {
  ...
  console.log(`✅ Update admin roles migration applied successfully!`);
}
