...
const sqlPath = path.resolve(__dirname, 'supabase/migrations/20260601130000_add_video_views_rpc.sql');
const query = fs.readFileSync(sqlPath, 'utf8');

console.log(`Connecting to project: ${projectRef}`);
console.log('Applying video views RPC migration...');
...
if (!res.ok) {
  ...
  console.log(`✅ Video views RPC migration applied successfully!`);
}
