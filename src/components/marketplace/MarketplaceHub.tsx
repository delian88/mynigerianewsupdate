...
export function MarketplaceHub() {
  ...
  const data: { automotive: AutomotiveItem[], realestate: RealEstateItem[], careers: CareerItem[] } = {
    automotive: [
      { id: 'a1', title: '2022 Toyota Prado (TX-L) - Full Option', price: '₦85,000,000', priceVal: 85000000, year: 2022, model: 'Toyota', location: 'Lagos, NG', badge: 'Verified Dealer', img: 'https://images.unsplash.com/photo-1617469767053-d3b523a0b982?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHRveW90YXxlbnwwfHwwfHx8MA%3D%3D' },
  ...
  // Local type guards for filtering
