      ...
      <div className="container-nag px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 h-full lg:min-h-[600px]">
        ...
        <div className="lg:col-span-8 group relative overflow-hidden rounded-2xl bg-white shadow-xl border border-nag-border flex flex-col min-h-[350px] md:min-h-[400px]">
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-12 z-20 w-full space-y-3 md:space-y-4">
            <span className="inline-block px-3 py-1 bg-nag-green-primary text-white text-[9px] md:text-[10px] font-black uppercase rounded-lg tracking-[0.2em] shadow-lg">Special Investigation</span>
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 text-gray-300 text-[9px] md:text-[10px] font-black uppercase tracking-widest opacity-90 border-t border-white/10 pt-4 md:pt-6">
          ...
          {[
            ...
            <div key={i} className="bg-white rounded-2xl p-4 md:p-5 border border-nag-border flex gap-4 md:gap-5 hover:shadow-xl transition-all cursor-pointer group flex-1">
              ...
              <div className="flex flex-col justify-between py-0.5 md:py-1 flex-1">
                ...
                <h3 className="text-sm md:text-base font-bold leading-snug group-hover:text-nag-green-primary transition-colors line-clamp-2 sm:line-clamp-3 tracking-tight">
                  {item.title}
                </h3>
